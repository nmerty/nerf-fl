...
class LearnPose(nn.Module):
    def __init__(self, num_cams, learn_R, learn_t, init_c2w=None, perturb_sigma=0):
        ...
        self.perturbation = nn.Parameter(convert3x4_4x4(torch.normal(0, perturb_sigma, [num_cams, 3, 4])), requires_grad=False) if perturb_sigma > 0 else None
    ...
    def forward(self, cam_id):
        ...
        if self.perturbation is not None:
            return c2w + self.perturbation[cam_id]
